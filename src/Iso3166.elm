module Iso3166 exposing
    ( iso3166Codes, countryNames, dialCodes
    , flagImageData, flagPositions
    )

{-| A collection of [ISO 3166-1](https://en.wikipedia.org/wiki/ISO_3166-1)
based data about countries. This library is intented to be used a


# Raw Data

@docs iso3166Codes, countryNames, dialCodes


# Css

@docs flagImageData, flagPositions
...
countryNames =
    Dict.fromList
        [ ( "AF", "Afghanistan (\u{202B}افغانستان\u{202C}\u{200E})" )
        , ( "AL", "Albania (Shqipëri)" )
        , ( "DZ", "Algeria (\u{202B}الجزائر\u{202C}\u{200E})" )
        , ( "AS", "American Samoa" )
        , ( "AD", "Andorra" )
        , ( "AO", "Angola" )
        , ( "AI", "Anguilla" )
        ...
        , ( "BS", "Bahamas" )
        , ( "BH", "Bahrain (\u{202B}البحرين\u{202C}\u{200E})" )
        ...
        , ( "CO", "Colombia" )
        , ( "KM", "Comoros (\u{202B}جزر القمر\u{202C}\u{200E})" )
        ...
        , ( "EC", "Ecuador" )
        , ( "EG", "Egypt (\u{202B}مصر\u{202C}\u{200E})" )
        , ( "SV", "El Salvador" )
        ...
        , ( "IN", "India (भारत)" )
        , ( "ID", "Indonesia" )
        , ( "IR", "Iran (\u{202B}ایران\u{202C}\u{200E})" )
        , ( "IQ", "Iraq (\u{202B}العراق\u{202C}\u{200E})" )
        , ( "IE", "Ireland" )
        , ( "IM", "Isle of Man" )
        , ( "IL", "Israel (\u{202B}ישראל\u{202C}\u{200E})" )
        , ( "IT", "Italy (Italia)" )
        , ( "JM", "Jamaica" )
        , ( "JP", "Japan (日本)" )
        , ( "JE", "Jersey" )
        , ( "JO", "Jordan (\u{202B}الأردن\u{202C}\u{200E})" )
        , ( "KZ", "Kazakhstan (Казахстан)" )
        , ( "KE", "Kenya" )
        , ( "KI", "Kiribati" )
        , ( "XK", "Kosovo" )
        , ( "KW", "Kuwait (\u{202B}الكويت\u{202C}\u{200E})" )
        , ( "KG", "Kyrgyzstan (Кыргызстан)" )
        , ( "LA", "Laos (ລາວ)" )
        , ( "LV", "Latvia (Latvija)" )
        , ( "LB", "Lebanon (\u{202B}لبنان\u{202C}\u{200E})" )
        , ( "LS", "Lesotho" )
        , ( "LR", "Liberia" )
        , ( "LY", "Libya (\u{202B}ليبيا\u{202C}\u{200E})" )
        , ( "LI", "Liechtenstein" )
        ...
        , ( "MH", "Marshall Islands" )
        , ( "MQ", "Martinique" )
        , ( "MR", "Mauritania (\u{202B}موريتانيا\u{202C}\u{200E})" )
        , ( "MU", "Mauritius (Moris)" )
        , ( "YT", "Mayotte" )
        , ( "MX", "Mexico (México)" )
        , ( "FM", "Micronesia" )
        ...
        , ( "MS", "Montserrat" )
        , ( "MA", "Morocco (\u{202B}المغرب\u{202C}\u{200E})" )
        ...
        , ( "NO", "Norway (Norge)" )
        , ( "OM", "Oman (\u{202B}عُمان\u{202C}\u{200E})" )
        , ( "PK", "Pakistan (\u{202B}پاکستان\u{202C}\u{200E})" )
        , ( "PW", "Palau" )
        , ( "PS", "Palestine (\u{202B}فلسطين\u{202C}\u{200E})" )
        , ( "PA", "Panama (Panamá)" )
        , ( "PG", "Papua New Guinea" )
        , ( "PY", "Paraguay" )
        , ( "PE", "Peru (Perú)" )
        ...
        , ( "PT", "Portugal" )
        , ( "PR", "Puerto Rico" )
        , ( "QA", "Qatar (\u{202B}قطر\u{202C}\u{200E})" )
        ...
        , ( "SA", "Saudi Arabia (\u{202B}المملكة العربية السعودية\u{202C}\u{200E})" )
        , ( "SN", "Senegal (Sénégal)" )
        , ( "RS", "Serbia (Србија)" )
        , ( "SC", "Seychelles" )
        , ( "SL", "Sierra Leone" )
        ...
        , ( "ZA", "South Africa" )
        , ( "KR", "South Korea (대한민국)" )
        , ( "SS", "South Sudan (\u{202B}جنوب السودان\u{202C}\u{200E})" )
        , ( "ES", "Spain (España)" )
        , ( "LK", "Sri Lanka (ශ්\u{200D}රී ලංකාව)" )
        , ( "SD", "Sudan (\u{202B}السودان\u{202C}\u{200E})" )
        , ( "SR", "Suriname" )
        , ( "SJ", "Svalbard and Jan Mayen" )
        , ( "SZ", "Swaziland" )
        , ( "SE", "Sweden (Sverige)" )
        , ( "CH", "Switzerland (Schweiz)" )
        , ( "SY", "Syria (\u{202B}سوريا\u{202C}\u{200E})" )
        , ( "TW", "Taiwan (台灣)" )
        , ( "TJ", "Tajikistan" )
        , ( "TZ", "Tanzania" )
        , ( "TH", "Thailand (ไทย)" )
        ...
        , ( "TN", "Tunisia (\u{202B}تونس\u{202C}\u{200E})" )
        , ( "TR", "Turkey (Türkiye)" )
        , ( "TM", "Turkmenistan" )
        ...
        , ( "UG", "Uganda" )
        , ( "UA", "Ukraine (Україна)" )
        , ( "AE", "United Arab Emirates (\u{202B}الإمارات العربية المتحدة\u{202C}\u{200E})" )
        , ( "GB", "United Kingdom" )
        , ( "US", "United States" )
        , ( "UY", "Uruguay" )
        ...
        , ( "EH", "Western Sahara (\u{202B}الصحراء الغربية\u{202C}\u{200E})" )
        , ( "YE", "Yemen (\u{202B}اليمن\u{202C}\u{200E})" )
        , ( "ZM", "Zambia" )
        , ( "ZW", "Zimbabwe" )
        ]
